...
func TestComputeDiffSearchMatches(t *testing.T) {
	data := &diff.Data{
		Rows: []diff.Row{
			{OldLineNum: 1, NewLineNum: 1, OldText: "hello world", NewText: "hello world", RowType: diff.RowUnchanged},
			{OldLineNum: 2, NewLineNum: 0, OldText: "old line", RowType: diff.RowDeleted},
			{OldLineNum: 0, NewLineNum: 2, NewText: "new line hello", RowType: diff.RowAdded},
		},
	}
